class EntityB extends Entity {//  blue Etitiy
    constructor(loc, vel, sz, wrld) {
        ...
        this.ents = this.wrld.entities.entityB;
        this.closest = 100000;
        this.clsIndex = -1;
        this.updateRowCol = 0;
      ...
      update() {
        ...
        //????????????????????????????????????  do we need to update row col every frame
        if(this.updateRowCol++ >= 30){
