class EntityP extends Entity {//  blue Etitiy
    constructor(loc, vel, sz, wrld) {
        ...
        this.ents = this.wrld.entities.entityP;
        this.closest = 100000;
        this.clsIndex = -1;
      ...
      render() {
        ...
        // ctx.fillText("r = " + r, this.loc.x - 15, this.loc.y-15);
        // ctx.fillText("c = " + c, this.loc.x - 15, this.loc.y-5);
        // ctx.font = "11px Verdana";
        // let x = Math.floor(this.loc.x);
        // let y = Math.floor(this.loc.y);
        // ctx.fillText("x = " + x, this.loc.x - 15, this.loc.y+12);
        // ctx.fillText("y = " + y, this.loc.x - 15, this.loc.y+22);
        ctx.beginPath();
